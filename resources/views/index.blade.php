        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 mb-4 mb-md-0">
                    <div class="card border-0 h-100 hover-lift">
                        <div class="card-img-top overflow-hidden">
                            <img src="{{ asset('assets/images/type-space-1.jpg') }}" alt="Meeting space" class="img-fluid w-100 hover-zoom" style="height: 240px; object-fit: cover;">
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    <div class="card border-0 h-100 hover-lift">
                        <div class="card-img-top overflow-hidden">
                            <img src="{{ asset('assets/images/type-space-2.jpg') }}" alt="Coworking space" class="img-fluid w-100 hover-zoom" style="height: 240px; object-fit: cover;">
                            <div class="img-overlay bg-dark-50 d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-4">
                    <div class="card border-0 h-100 hover-lift">
                        <div class="card-img-top overflow-hidden">
                            <img src="{{ asset('assets/images/type-space-3.jpg') }}" alt="Private Office" class="img-fluid w-100 hover-zoom" style="height: 240px; object-fit: cover;">
                            <div class="img-overlay bg-dark-50 d-flex align-items-center justify-content-center">
    ...
    <section class="py-8 py-lg-14 bg-light">
        <div class="container">
            <div class="row align-items-center mb-6">
                <div class="col-lg-8">
                    <h2 class="mb-2">Explore Our Available Office Spaces</h2>
                    <p class="lead text-muted mb-0">
                        Discover workspaces that match your business style and requirements
                    </p>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center mb-6">
                    ...
                    <h2 class="mb-3">Simple Process for Everyone</h2>
                    <p class="lead text-muted">
                        Whether you're listing a space or looking for one, Spacely makes it easy
                    </p>
                </div>
            </div>
                ...
                <div class="col-lg-6 mb-4 d-flex">
                    <div class="card border-0 shadow-sm w-100 hover-lift">
                        <div class="card-header bg-primary text-white py-3">
                            <h3 class="h5 mb-0 text-center">For Space Owners</h3>
                        </div>
                        <div class="card-body p-4 d-flex flex-column">
                            <div class="d-flex mb-4 flex-grow-1">
                                ...
                                <div class="ms-4">
                                    <h4 class="h5 mb-2">List Your Space</h4>
                                    <p class="text-muted mb-0">
                                        Create your listing in minutes with our simple onboarding process
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="d-flex mb-4 flex-grow-1">
                                ...
                                <div class="ms-4">
                                    <h4 class="h5 mb-2">Get Discovered</h4>
                                    <p class="text-muted mb-0">
                                        Your space becomes visible to our community of professionals
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="d-flex flex-grow-1">
                                ...
                                <div class="ms-4">
                                    <h4 class="h5 mb-2">Earn Income</h4>
                                    <p class="text-muted mb-0">
                                        Receive guaranteed payments for every booking
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 d-flex">
                    <div class="card border-0 shadow-sm w-100 hover-lift">
                        <div class="card-header bg-secondary text-white py-3">
                            <h3 class="h5 mb-0 text-center">For Space Seekers</h3>
                        </div>
                        <div class="card-body p-4 d-flex flex-column">
                            <div class="d-flex mb-4 flex-grow-1">
                                ...
                                <div class="ms-4">
                                    <h4 class="h5 mb-2">Find Your Space</h4>
                                    <p class="text-muted mb-0">
                                        Browse our curated collection of workspaces filtered by your specific needs and preferences
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="d-flex mb-4 flex-grow-1">
                                ...
                                <div class="ms-4">
                                    ...
                                    <p class="text-muted mb-0">
                                        Reserve your preferred space with our seamless booking system in just a few clicks
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="d-flex flex-grow-1">
                                ...
                                <div class="ms-4">
                                    <h4 class="h5 mb-2">Start Working</h4>
                                    <p class="text-muted mb-0">
                                        Multiple payment options with instant confirmation and digital access to your space
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row mt-6">
                <div class="col-12 text-center">
                    <a href="{{ route('auth.register') }}" class="btn btn-primary px-5 py-3 hover-scale">
                        Get Started with Spacely
                    </a>
                </div>
            </div>
        </div>
